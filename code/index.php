...
<body>
    ...
    <main id="content" class="website-content">
        ...
        <div class="trainers-section__row">
            <div class="trainers-slider slick-initialized slick-slider">
                <div class="slick-list draggable">
                    <div class="slick-track" style="opacity: 1; width: 100%; transform: translate3d(0px, 0px, 0px);">
                        <article class="trainer slick-slide" style="width: 100%; display: inline-block;">
                        ...
                        <article class="trainer slick-slide" style="width: 100%; display: inline-block;">
                            <div class="trainer__wrap">
                                ...
                                <div class="trainer__content">
                                    <div class="trainer__header">
                                        <h3 class="trainer__name">Sacha Scheepens-Schultz</h3>
                                        <p class="trainer__subs">‘Plezier staat voorop’</p>
                                    </div>
                                    <p class="trainer__text">Mijn naam is Sacha Scheepens-Schultz. Met meer dan
                                        20 jaar coachervaring... </p>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="trainer slick-slide" style="width: 100%; display: inline-block;">
                            <div class="trainer__wrap">
                                <div class="trainer__thumb">
                                    <img decoding="async" src="https://padelpoints.nl/wp-content/uploads/2023/09/Borja-Camacho-1-500x500.jpg"
                                         class="attachment-skywalker-500x500 size-skywalker-500x500 wp-post-image" alt="Borja Camacho" />
                                </div>
                                <div class="trainer__content">
                                    <div class="trainer__header">
                                        <h3 class="trainer__name">Borja Camacho</h3>
                                        <p class="trainer__subs">“Nieuwsgierigheid is één van mijn drijfveren”</p>
                                    </div>
                                    <p class="trainer__text">Padel en tennis zijn altijd essentieel geweest in
                                        mijn leven. Ik begon al op 10-jarige leeftijd... </p>
                                </div>
                            </div>
                        </article>
                        ...
                        <article class="trainer slick-slide" style="width: 100%; display: inline-block;">
                            <div class="trainer__wrap">
                                <div class="trainer__thumb">
                                    <img decoding="async" src="https://padelpoints.nl/wp-content/uploads/2024/01/B412C506-74D7-454B-8057-2E82211D4762_1_201_a-463x500.jpeg"
                                         class="attachment-skywalker-500x500 size-skywalker-500x500 wp-post-image" alt="Rutger van Munster" />
                                </div>
                                <div class="trainer__content">
                                    <div class="trainer__header">
                                        <h3 class="trainer__name">Rutger van Munster</h3>
                                        <p class="trainer__subs">“Laten we samen aan de slag gaan.”</p>
                                    </div>
                                    <p class="trainer__text">Ben je padel verslaafd of overweeg je het eens uit
                                        te proberen met wat lessen? Ongeacht je motivatie...</p>
                                </div>
                            </div>
                        </article>
                    </div>
